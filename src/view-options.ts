...
import BasicNodeComponent from "./components/BasicNodeComponent.svelte";
import SetVariablesComponent from "./components/SetVariablesComponent.svelte";
import RequestNodeComponent from "./components/RequestNodeComponent.svelte";
import KeypadEntryComponent from "./components/KeypadEntryComponent.svelte";
import ConditionsComponent from "./components/ConditionsComponent.svelte";
import CallForwardingComponent from "./components/CallForwardingComponent.svelte";
import {SvelteSurfaceViewOptions} from "@visuallyjs/browser-ui-svelte/definitions";
 ...
 */
const viewOptions:SvelteSurfaceViewOptions = {
    nodes: {
